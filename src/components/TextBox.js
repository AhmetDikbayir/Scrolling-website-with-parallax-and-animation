...
const TextBox = () => {
    ...
    return (
        <div className='text-box'>
            ...
            <Typical
                steps={['What', 1000, 'What kind', 1000, 'What kind of', 1000, 'What kind of activities', 1000, 'What kind of activities can',1500, 'What kind of activities can you', 1500, 'What kind of activities can you do', 1500, 'What kind of activities can you do there?', 3000]}
